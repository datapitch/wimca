...
function sendSMS() {
    ...
    if(preg_match('/^234/', $number)) {
        ...
        $num = preg_replace('/^(?:\?234|0)?/','234', $number); 
...
function sendRegistrationEmailAdmin() {
    ...
    $messageAdmin .= '<img src="https://ik.imagekit.io/nga4iqewcs4/wimca-admin_B31cPRbXKcL?updatedAt=1633013434464" />';
